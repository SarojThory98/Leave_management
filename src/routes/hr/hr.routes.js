...
hrRouter.patch("/hr/edit-user-information", verifyToken([USER_TYPE_ENUM.HR]), updateUserInformation);
hrRouter.get("/hr/logout", verifyToken([USER_TYPE_ENUM.HR]), logoutUser);
